      ...
      <div className="assessor__content">
        ...
        <div className="assessor__content-right">
          <div className="assessor__content-right__red-block">
            ...
            <p className="assessor__content-right__red-block__description">
              Dejanos tu contacto en el formulario y nuestros expertos te asesorarán.
            </p>
          </div>
        </div>
        <p className="assessor__content__mobile-description">
          Dejanos tu contacto en el formulario y nuestros expertos te asesorarán.
        </p>
      </div>
    </div>
