    ...
    return (
        <Container>
            <div className='d-none d-md-block'>
                <Container styles={{ background: 'url("/banner-hero-desktop.png")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: '646px', overflow: 'hidden', color: '#FFFFFF' }}>
            ...
            <div className='d-block d-md-none'>
                <Container styles={{ background: 'url("/banner-hero-mobile.png")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: '266px', overflow: 'hidden', color: '#FFFFFF' }}>
                    ...
                    <div style={{ zIndex: 1, width: '100%', float: 'right', top: '44%', position: 'relative' }}>
                        ...
                        <Text color={'#fff'} fontSize="14px" textAlign="center" marginTop={'10px'} paddingLeft="15px" paddingRight="15px" >
                            Una compañía dedicada a la comprensión del comportamiento de los pernos y tornillos en servicio
                        </Text>
                    </div>
                </Container>
