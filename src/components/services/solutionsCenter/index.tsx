    ...
    <div className="container_solutions">
      ...
      <div className="container_solutions_description">
        ...
        <p className="solutions_description">
          Nos adaptamos a sus requerimientos mediante un trabajo en conjunto para integrar
          habilidades y destrezas en base a la mejora, prevención y seguridad empresarial.
        </p>
      </div>
